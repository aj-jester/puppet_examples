...
def build_node_url():
    url = "%(addr)s/v1/health/node/%(host)s?dc=%(dc)s" % arguments
    dump("Url: " + url)
    return url
...
def prepare_args():
    ...
    parser.add_argument('--host', default=None, type=str, help='the consul node_name')
    parser.add_argument('--dc', default=None, type=str, help='the consul datacenter')
    parser.add_argument('--addr', default='http://localhost:8500',
                             help='consul address [default: http://localhost:8500]')
    parser.add_argument('--verbose', default=False, type=bool, help='verbose output')
    parser.add_argument('--CheckID', default=None, type=str, help='CheckID matcher')
    parser.add_argument('--ServiceName', default=None, type=str, help='ServiceName matcher')
